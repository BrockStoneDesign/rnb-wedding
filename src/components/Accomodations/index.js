                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        <div className='card'>
                            ...
                            <p>Small, local airport. Can be a money saver for some that can fly direct to this airport. An added bonus, you will be flying over St. Vincent Basilica, where Rhylee and Brock will be wed!</p>
                    ...
                    <div className="col-6">
                        <div className='card'>
                            ...
                            <p>We have set aside a block of rooms for our guests. Please contact the hotel directly (link provided below).</p>
                            <p>To receive the group rate, you must use <strong>Kenmey Stone Wedding</strong>.</p>
                            <p>Rooms must be booked by April 20, 2019 to receive the discouted price.</p>

                            <div id='airport-sec'>
                                <p><strong>Courtyards FREE Shuttle service!</strong></p>
                                <p>The hotel also offers a shuttle service which can take you to and from the 'Happily Ever After Party' (However, you will need to consider transportation to / from the Church)</p>
                            </div>
